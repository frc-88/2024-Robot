...
public class TunerConstants {
    ...
    private static final double kFrontLeftEncoderOffset = .818;
    ...
    private static final double kFrontRightEncoderOffset = .337;
    ...
    private static final double kBackLeftEncoderOffset = .045;
