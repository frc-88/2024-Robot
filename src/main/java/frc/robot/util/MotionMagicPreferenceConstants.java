...
/**
 * Class used for MotionMagic control, using Velocity, Acceleration, Jerk, and
 * PID control
 */
...
public class MotionMagicPreferenceConstants {
     ...
     *                        The derivative gain
     * @param kV
     *                        The velocity feedforward gain. Units should be
     *                        determined depending on the request used
     * @param kS
     *                        The static friction feedforward gain. Units should be
     *                        determined depending on the request used
     */
