...
public class Shooter extends SubsystemBase {
    ...
    private DoublePreferenceConstant p_primeSpeed = new DoublePreferenceConstant(
            "shooter/shooter/PrimeSpeed", 2200);
    ...
    public boolean isShooterAtAlmostFullSpeed() {
        return m_LeftShooter.getVelocity().getValueAsDouble() * 60 > leftShooterSpeed.getValue() - 3500
                && m_RightShooter.getVelocity().getValueAsDouble() * 60 > rightShooterSpeed.getValue() - 3500;
    }
    ...
    public boolean isShooterAtSlowSpeed() {
        return (Math.abs(m_LeftShooter.getVelocity().getValueAsDouble() * 60 - p_slowSpeed.getValue()) <= 200
                && Math.abs(
                        m_RightShooter.getVelocity().getValueAsDouble() * 60 - p_slowSpeed.getValue()) <= 200);
    }
