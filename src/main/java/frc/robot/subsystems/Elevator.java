...
public class Elevator extends SubsystemBase {
    ...
    private DoublePreferenceConstant p_maxAcceleration = new DoublePreferenceConstant("Elevator/MotionMagicAcceleration", 0);
    ...
    public void periodic() {
        SmartDashboard.putNumber("Shooter Angle", m_pivotMotor.getPosition().getValueAsDouble() * kMotorRotationToShooterAngle);
    }
}
