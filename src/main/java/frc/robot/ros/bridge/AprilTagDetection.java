...
public class AprilTagDetection extends frc.team88.ros.messages.RosMessage {
    ...
    public AprilTagDetection(java.lang.Integer[] id, java.lang.Double[] size,
            frc.team88.ros.messages.geometry_msgs.PoseWithCovarianceStamped pose) {
    ...
    public AprilTagDetection(JsonObject jsonObj) {
        ...
        this.pose = new frc.team88.ros.messages.geometry_msgs.PoseWithCovarianceStamped(
