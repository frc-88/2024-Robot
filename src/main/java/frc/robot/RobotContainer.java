...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        final Lights m_lights = new Lights(drivetrain::isSwerveReady, m_intake::isIntakeReady,
                m_elevator::isElevatorReady, m_intake::isIndexerReady, m_shooter::isShooterReady,
                m_climber::isClimberReady,
